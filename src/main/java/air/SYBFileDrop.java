...
public class SYBFileDrop
{
	...
	/**
	 * Constructs a {@link SYBFileDrop} with a default light-blue border
	...
	public static interface Listener {
		 ...
		 * @since 1.0
		 */
		public abstract void filesDropped(File[] files) throws IOException;
	...
	public static class Event extends java.util.EventObject {
		 ...
		 * {@link SYBFileDrop} that initiated the event.
		 *
	...
	public static class TransferableObject implements java.awt.datatransfer.Transferable
	{
		...
		public final static DataFlavor DATA_FLAVOR =
				new DataFlavor( SYBFileDrop.TransferableObject.class, MIME_TYPE );
